...
// @homepage	    https://github.com/jjohns71/Monkey-Scripts/blob/master/Amazon%20Camel%20Graph%20Revived%20With%20https%20Fix.js
...
if (chart=="amazon"||chart=="amazon-new"||chart=="amazon-new-used"||chart=="amazon-used")
{
	...
	{
        if (!responseDoc.getElementById('price_type_0') && chartpost===0)
        {
...
{
        if (!responseDoc.getElementById('price_type_1') && chartpost===0)
        {
$("#averageCustomerReviews_feature_div").append("<div id='camelcamelcamel' style='margin-top: 10px; margin-left: -10px'>" + link2 + "</div>");
chartpost = 1;
	      }
...
{
        if (!responseDoc.getElementById('price_type_2') && chartpost===0)
        {
$("#averageCustomerReviews_feature_div").append("<div id='camelcamelcamel' style='margin-top: 10px; margin-left: -10px'>" + link2 + "</div>");
